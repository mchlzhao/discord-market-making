...
class TestController(unittest.TestCase):
    ...
    def test_all(self):
        ...
        self.assertTrue(len(order_book0.sell_orders[60]) == 0)
        ...
        self.assertTrue(result[0] == 0)
        self.assertTrue(len(order_book0.sell_orders[60]) == 0)
        self.assertTrue(order_book0.sell_orders[100][0] == self.accounts[0])

        # trade
        result = self.controller.process_bid(1, 1, Side.BUY, 100, do_write)
        self.assertTrue(result[0] == 0)
        self.assertIsNotNone(result[1])
        self.assertTrue(self.accounts[0].balance == 100 and self.accounts[0].inventory[settings.PRODUCTS[0]] == -1)
        self.assertTrue(self.accounts[1].balance == -100 and self.accounts[1].inventory[settings.PRODUCTS[0]] == 1)
        ...
        self.assertTrue(self.accounts[0].inventory[settings.PRODUCTS[0]] == -settings.POSITION_LIMIT)
        self.assertTrue(self.accounts[1].inventory[settings.PRODUCTS[0]] == settings.POSITION_LIMIT)

        result = self.controller.process_bid(0, 1, Side.SELL, 100, do_write)
        self.assertTrue(result[0] == -1)
        self.assertTrue(len(order_book0.sell_orders[100]) == 0)
        result = self.controller.process_bid(1, 1, Side.BUY, 100, do_write)
        self.assertTrue(result[0] == -1)
        self.assertTrue(len(order_book0.buy_orders[100]) == 0)

        # marking occurred
        self.assertTrue(self.accounts[0].balance == 500)
        self.assertTrue(self.accounts[1].balance == -500)
        self.controller.mark_occurred(1, True, do_write)
        self.assertTrue(self.accounts[0].balance == 0)
        self.assertTrue(self.accounts[1].balance == 0)
